...
tests = sys.argv[1:] or [
    'tests/test_story_craft.py', 'tests/test_media_library.py', 'tests/test_story_language.py', 'tests/test_story_quality.py', 'tests/test_story_director.py', 'tests/test_editorial.py',
