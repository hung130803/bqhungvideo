...
def enqueue_export(pool: WorkerPool, clip_id: int, video_id: int,
                   ...
                   recap_emotion: bool = True,
                   recap_narr_color: str = "", recap_narr_italic: bool = True,
                   recap_narr_same: bool = False,
    ...
    extra = hashlib.sha1(
        repr((text_overlays, cap_style, out_name, out_dir, ovl,
              ...
              recap_narr_color, bool(recap_narr_italic), bool(recap_narr_same),
    ...
    return pool.enqueue(
        ...
        {"clip_id": clip_id, "out_w": out_w, "out_h": out_h,
         ...
         "recap_emotion": recap_emotion,
         "recap_narr_color": recap_narr_color,
         "recap_narr_italic": recap_narr_italic,
         "recap_narr_same": recap_narr_same,
